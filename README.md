...
| High-water marks | [STN flood event data](https://stn.wim.usgs.gov/STNDataPortal/) | validated flood event observations from United States Geological Survey | CSV | 1.[Report](REPORT.md)<br>2.[Guide](GUIDE.md)<br>3.Data |
...
| [Normalized Difference Water Index](https://eos.com/make-an-analysis/ndwi/) masks |  | created mask used to identify the water bodies and refine the algorithm's accuracy | GeoTIFF | 1.[Report](REPORT.md)<br>2.[Guide](GUIDE.md)<br>3.Data |
| Flowlines | National Hydrography Dataset | Flowing water data used to enhance analysis and improve algorithm performance | Shapefiles | 1.[Report](REPORT.md)<br>2.[Guide](GUIDE.md)<br>3.Data |
